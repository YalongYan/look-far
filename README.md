...
| 系统 | 文件 |
| --- | --- |
| macOS（Apple 芯片，M1/M2/M3/M4） | `release/远方-1.0.2-mac-arm64.dmg` |
| macOS（Intel） | `release/远方-1.0.2-mac-x64.dmg` |
| Windows x64 | `release/远方-1.0.2-win-x64-setup.exe` |
| Windows ARM | `release/远方-1.0.2-win-arm64-setup.exe` |
